package com.remodstudios.endless.block.entity.screen;

import com.remodstudios.endless.block.entity.screen.widget.WFgBgBar;
...
public class BeaconOfUndyingScreenHandler extends SyncedGuiDescription {
	public BeaconOfUndyingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext ctx) {
		...
		WFgBgBar bar = new WFgBgBar(this.getPropertyDelegate(), 1, 4, 0xAAFFAA);
		bar.setSize(32, 16);
		root.add(bar, 3, 1);
