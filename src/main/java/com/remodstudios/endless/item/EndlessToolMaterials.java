...
public enum EndlessToolMaterials implements ToolMaterial {
	FINALLIUM(ToolMaterials.IRON);
	...
	EndlessToolMaterials(int durability, float miningSpeedMultiplier, float attackDamage, int miningLevel, int enchantibility, Supplier<Ingredient> repairIngredientSupplier) {
	...
	EndlessToolMaterials(ToolMaterial material) {
